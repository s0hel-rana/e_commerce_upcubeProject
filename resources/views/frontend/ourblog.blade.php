   ...
   <main>
    ...
    <section class="breadcrumb__wrap">
        ...
        <div class="breadcrumb__wrap__icon">
            <ul>
                <li><img src="{{ asset('ui/frontend') }}/assets/img/icons/breadcrumb_icon01.png" alt=""></li>
                <li><img src="{{ asset('ui/frontend') }}/assets/img/icons/breadcrumb_icon02.png" alt=""></li>
                <li><img src="{{ asset('ui/frontend') }}/assets/img/icons/breadcrumb_icon03.png" alt=""></li>
                <li><img src="{{ asset('ui/frontend') }}/assets/img/icons/breadcrumb_icon04.png" alt=""></li>
                <li><img src="{{ asset('ui/frontend') }}/assets/img/icons/breadcrumb_icon05.png" alt=""></li>
                <li><img src="{{ asset('ui/frontend') }}/assets/img/icons/breadcrumb_icon06.png" alt=""></li>
            </ul>
        </div>
    </section>
    <!-- breadcrumb-area-end -->
