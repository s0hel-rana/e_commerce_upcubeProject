...
<html class="no-js" lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{  asset('ui/frontend')  }}/assets/css/animate.min.css">
        ...
        <link rel="stylesheet" href="{{  asset('ui/frontend')  }}/assets/css/slick.css">
        <link rel="stylesheet" href="{{  asset('ui/frontend')  }}/assets/css/default.css">
        <link rel="stylesheet" href="{{  asset('ui/frontend')  }}/assets/css/style.css">
        <link rel="stylesheet" href="{{  asset('ui/frontend')  }}/assets/css/responsive.css">
    </head>
    <body>
        ...
        <script src="{{  asset('ui/frontend')  }}/assets/js/element-in-view.js"></script>
        <script src="{{  asset('ui/frontend')  }}/assets/js/slick.min.js"></script>
        <script src="{{  asset('ui/frontend')  }}/assets/js/ajax-form.js"></script>
        <script src="{{  asset('ui/frontend')  }}/assets/js/wow.min.js"></script>
        <script src="{{  asset('ui/frontend')  }}/assets/js/plugins.js"></script>
