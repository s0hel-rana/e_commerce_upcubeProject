                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.store.profile') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <div class="col-sm-10">
                                        <img class="card-img-top img-fluid img-thumbnail rounded" id="showImage" src="{{ asset('upload/home_slider_image') }}/{{ $homeSlider->slider_image }}" alt="Card image cap" style="width: 12rem">
                                    </div>
                                </div>
                                <div class="mb-3">
